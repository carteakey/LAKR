...
examples = [
    ...
    {
        "text": 'If you are looking for a book to teach your baby/toddler about emotions, I highly recommend the Playschool book "Baby Faces"',
        "head": "The Feelings Book",
        "head_type": "Book",
        "relation": "SIMILAR_TO_BOOK",
        "tail": "Baby Faces",
        "tail_type": "Book",
    },
    {
        "text": 'For toddlers and young children I recommend "Big Feelings"',
        "head": "The Feelings Book",
        "head_type": "Book",
        "relation": "SIMILAR_TO_BOOK",
        "tail": "Big Feelings",
...
system_prompt = (
    ...
    "The allowed nodes are: Book, Concept, Feature. The allowed relationships are: OTHER_BOOKS_RECOMMENDED, HAS_FEATURES, DEALS_WITH_CONCEPTS, SIMILAR_TO_BOOK. Make sure that OTHER_BOOKS_RECOMMENDED is a relationship between two Book nodes, HAS_FEATURES is a relationship between a Book and a Feature node, DEALS_WITH_CONCEPTS is a relationship between a Book and a Concept node, and SIMILAR_TO_BOOK is a relationship between two Book nodes. e.g. Very well is not a valid relationship. Very well is not a valid node."
)
...
def _format_nodes(nodes: List[Node]) -> List[Node]:
    return [
        Node(
            ...
            type=(
                el.type.capitalize() if el.type else None  # type: ignore[arg-type]
            ),  # handle empty strings  # type: ignore[arg-type]
